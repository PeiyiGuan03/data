...
><font color=#A8A8A8>注：报告将包装总使用量分为快递“直接使用”包装及“间接使用”包装。上图呈现的数值是“直接使用”包装量。           
    快递“直接使用”包装是指由快递网点通过总部配发、自行采购、回收等方式获得，以保护运件、方便运输为目的而消耗的快递包装及耗材；快递“间接使用”包装是指由客户（包括电商、企业及个人等）提供，以保护运件、方便运输为目的而消耗的快递包装及耗材，其主要来源是各类电商平台和个人。</font>
