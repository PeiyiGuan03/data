# 第四-五周作业      
## 快递垃圾：快消行业背后，是漫长的消解         
<font face="方正宋刻本秀楷简体">&ensp;&ensp;&ensp;&ensp;近日，国家邮政局制定《2019年快递业务旺季服务保障工作方案》，指出2019年快递业务旺季自11月初至2020年春节前夕，共计85天，“双11”期间（11月11日至18日）将出现旺季峰值。  
&ensp;&ensp;&ensp;&ensp;快速消费品（FMCG，Fast Moving Consumer Goods）原本是指使用寿命较短，消费速度较快的消费品，尤其是许多消费者高频次使用的日常用品。而一种新的叫法是PMCG（Packaged Mass Consumption Goods），即更加着重包装、品牌化以及大众化的影响。伴随物质快速消费时代的到来，快递运输行业迅速崛起。作为快消品物流的核心，经销商出于运输安全、降低成本的考虑，往往使用塑料袋、填充物、纸箱等包装材料将物品层层包裹，包装的体积质量甚至超过物品本身。</font>       
![2010-2018快递行业](图片1.png)         
<font face="方正宋刻本秀楷简体">&ensp;&ensp;&ensp;&ensp;据国家邮政局，2018年我国快递业务收入超过6000亿元，快递业务量超过500亿件，人均使用快递36件。快递业务量比十年前超过二十倍，与生产关系和市场的变化息息相关。人们从计划经济到狂热消费只用了几十年的时间，物质的快速更迭消耗为生产者带来经济利益，而废弃物的处置却被“遗忘”于物质生产链条之外。文化研究者鲍曼曾言，“废弃物是所有生产中最羞于被提及，最黑暗的秘密”，它内在于现代文明生产秩序内部。“双十一”等电商节的交易额达到千亿级别，而快递包装垃圾，正是光鲜物质时代背后阴影的组成部分。</font>         
...
>注：报告将包装总使用量分为快递“直接使用”包装及“间接使用”包装。上图呈现的数值是“直接使用”包装量。快递“直接使用”包装是指由快递网点通过总部配发、自行采购、回收等方式获得，以保护运件、方便运输为目的而消耗的快递包装及耗材；快递“间接使用”包装是指由客户（包括电商、企业及个人等）提供，以保护运件、方便运输为目的而消耗的快递包装及耗材，其主要来源是各类电商平台和个人。   

<font face="方正宋刻本秀楷简体">&ensp;&ensp;&ensp;&ensp;
...
3.数据收集过程           
在一些已有报道上看到，垃圾相关的数据是在住房与城建部（虽然不知道为什么），但是统计年鉴的数据有点宏观，难以找到一个切入点，包括我后来找的邮政局的快递市场报告也一样，侧重包装垃圾这部分每年的表述都略有差别，而且信息更新不及时，在官网上也没有将这类数据报告类信息与新闻文稿类信息分开来，给搜索增添了一定难度。（政府网站的信息公开建设也是亟待提升啊）
4.数据分析和呈现的步骤          
图做了一整天，最后做的两张图是最后一个小时内做出来的。
5.选择报道角度的思考过程       
* 首先是资料收集       
* 话题太大，想要找到能用几百字说明白的点有些困难。既要考虑数据和文本的相辅相成，又要言之有物，看资料的同时又会有怀疑自我的感觉（因为看到一些批判绿色消费的观点，也不乏很多从人文社会历史考古影像等领域注视垃圾与人的社会生产关系之类的作品，但是由于时间有限，只好在能够获取的数据上进行补充和引申。）但总而言之，这个思考的过程让人收获许多。           
* 关于数据新闻中数据和文字关系的思考。其实我一直以为数据新闻的生产逻辑更偏理性，而很多人文层面的解释却不是这样的，我不禁想，能不能寻找到合适的数据来使这些抽象的现象更具体可观，但是又觉得这是思维的两个层面，不知道其中有没有什么矛盾性。（可能是我能力有限）我看到的数据可视化多是反应表面的一些现象，再者就是从时间维度来看演变和趋势，对数据更深意义的挖掘还是需要文本的辅助。我在想数据和文字的关系，到底是文字进一步解释数据还是数据将文字具象化，应该是需要结合两者各自优势的，而且作为一个作品必须得是形成一个整体的。（我又陷入了整体和具体的问题唉）
