# 第四-五周作业      
## 快递垃圾：快消行业背后，是漫长的消解         
<font face="方正宋刻本秀楷简体" size=10>&ensp;&ensp;&ensp;&ensp;近日，国家邮政局制定《2019年快递业务旺季服务保障工作方案》，指出2019年快递业务旺季自11月初至2020年春节前夕，共计85天，“双11”期间（11月11日至18日）将出现旺季峰值。                 
   &ensp;&ensp;&ensp;&ensp;快速消费品（FMCG，Fast Moving Consumer Goods）原本是指使用寿命较短，消费速度较快的消费品，尤其是许多消费者高频次使用的日常用品。而一种新的叫法是PMCG（Packaged Mass Consumption Goods），即更加着重包装、品牌化以及大众化的影响。伴随物质快速消费时代的到来，快递运输行业迅速崛起。作为快消品物流的核心，经销商出于运输安全、降低成本的考虑，往往使用塑料袋、填充物、纸箱等包装材料将物品层层包裹，包装的体积质量甚至超过物品本身。
</font>       
...
5.选择报道角度的思考过程       
1、首先是资料收集
2、话题太大，想要找到能用几百字说明白的点有些困难。既要考虑数据和文本的相辅相成，又要言之有物，看资料的同时又会有怀疑自我的感觉（因为看到一些批判绿色消费的观点，也不乏很多从人文社会历史考古影像等领域注视垃圾与人的社会生产关系之类的作品，但是由于时间有限，只好在能够获取的数据上进行补充和引申。）但总而言之，这个思考的过程让人收获许多。           
3、关于数据新闻中数据和文字关系的思考。其实我一直以为数据新闻的生产逻辑更偏理性，而很多人文层面的解释却不是这样的，我不禁想，能不能寻找到合适的数据来使这些抽象的现象更具体可观，但是又觉得这是思维的两个层面，不知道其中有没有什么矛盾性。（可能是我能力有限）我看到的数据可视化多是反应表面的一些现象，再者就是从时间维度来看演变和趋势，对数据更深意义的挖掘还是需要文本的辅助。我在想数据和文字的关系，到底是文字进一步解释数据还是数据将文字具象化，应该是需要结合两者各自优势的，而且作为一个作品必须得是形成一个整体的。（我又陷入了整体和具体的问题唉）
